...
.widget_authors .authors a{
  display: block;
  padding: 0.75em 0.8em;
  border-bottom: 1px dotted rgba(0, 0, 0, .2);
}
.widget_authors .authors a:hover{
  background-color: rgba(53, 143, 49, 0.1);
  opacity: 1;
}
</style>
<div id="" class="widget widget_authors">
  <h4 class="widgettitle"><span>事業所</span></h4>
  <div class="authors">
