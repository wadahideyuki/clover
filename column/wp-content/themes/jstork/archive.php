...
<?php } elseif (is_day()) { ?>
<h1 class="archive-title ttl-day h2"><?php the_time('Y年n月j日'); ?></h1>
<?php } elseif (is_month()) { ?>
<h1 class="archive-title ttl-month h2"><?php the_time('Y年n月'); ?></h1>
<?php } elseif (is_year()) { ?>
<h1 class="archive-title ttl-year h2"><?php the_time('Y年'); ?></h1>
<?php } ?>
</div>
